...
import livecricket.livecrickettv.cricketstreaming.SplashActivity;
...
//        if (BuildConfig.DEBUG) return false;
        ...
        if (checkVPN(currentActivity)) {
            ...
            detailMessage = "Please disable USB debugging from your phone to use the app.";
            isThreatDetected = true;
        }
...
//    }
    ...
    private static int checkDeveloperOP(Activity currentActivity) {
        return Settings.Secure.getInt(currentActivity.getContentResolver(), Settings.Secure.ADB_ENABLED, 0);
    }
}