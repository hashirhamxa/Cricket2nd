...
interface AppDao {
    ...
    @Transaction
    @Query("SELECT * FROM tournaments WHERE (sportType != 'cricket' AND sportType != 'football') ORDER BY sort ASC")    suspend fun getTrendingTournamentsWithEvents(): List<TournamentWithEvents>
