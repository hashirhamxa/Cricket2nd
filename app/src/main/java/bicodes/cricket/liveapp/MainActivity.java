...
import bicodes.cricket.liveapp.ui.MatchesFragment;
import bicodes.cricket.liveapp.ui.RecentFragment;
import bicodes.cricket.liveapp.ui.StandingsFragment;
import bicodes.cricket.liveapp.ui.UpcomingFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.action_privacy) {
            ...
            intent.setData(android.net.Uri.parse("https://doc-hosting.flycricket.io/cricketlive-privacy-policy/bd8e4355-2552-48a4-a1ad-c6fb526e8ffb/privacy"));
            startActivity(intent);
            return true;
        } else if (itemId == R.id.action_share) {
            String shareBody = "Download Cricket Live for live scores and cricket updates! https://play.google.com/store/apps/details?id=" + getPackageName();
