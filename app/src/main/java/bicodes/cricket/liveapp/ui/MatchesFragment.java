...
import bicodes.cricket.liveapp.adapters.MatchesAdapter;
import bicodes.cricket.liveapp.viewmodel.MatchesViewModel;
...
public class MatchesFragment extends Fragment {
    ...
    private void setupRecyclerView() {
        ...
        RecyclerView recyclerView = getView().findViewById(R.id.recycler_matches);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new MatchesAdapter(match -> {
    ...
    private void setupViewModel() {
        ...
        viewModel.getMatches().observe(getViewLifecycleOwner(), matches -> {
            if (matches != null && !matches.isEmpty()) {
                ...
                adapter.setMatches(new java.util.ArrayList<>());
